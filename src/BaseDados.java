...
public class BaseDados {
    ...
    public static void createLivros(){
        ...
        Livro livro3 = new Livro("Grande Sertão: Veredas", "Guimarães Rosa", 1956);
        Livro livro4 = new Livro("A Hora da Estrela", "Clarice Lispector", 1977);
        Livro livro5 = new Livro("Vidas Secas", "Graciliano Ramos", 1938);
        Livro livro6 = new Livro("Capitães da Areia", "Jorge Amado", 1937);
        Livro livro7 = new Livro("Memórias Póstumas de Brás Cubas", "Machado de Assis", 1881);
        Livro livro8 = new Livro("Iracema", "José de Alencar", 1865);
        Livro livro9 = new Livro("O Alienista", "Machado de Assis", 1882);
        Livro livro10 = new Livro("Macunaíma", "Mário de Andrade", 1928);
    ...
    private static void addLivro(Livro livro) {
        livros.add(livro);
    }
